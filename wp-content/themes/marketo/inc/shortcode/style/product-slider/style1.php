                        ...
                        <div class="col-md-6 align-self-center">
                            <div class="xs-best-deal-slider-content">
                                ...
                                <div class="xs-btn-wraper">
                                    <a href="<?php echo esc_url(get_the_permalink()); ?>" class="btn btn-outline-secondary icon-left">
                                        <i class="fa fa-shopping-basket"></i>
                                        <?php echo esc_html__('BUY NOW','marketo') ?>
                                    </a>
                                    <a href="<?php echo esc_url( $btn_link ); ?>" target="<?php echo esc_html( $btn_target ); ?>" class="btn btn-success"><?php echo esc_html($btn_label); ?></a>
                                </div>
                            </div>
                        </div>
                    </div><!-- .row END -->
