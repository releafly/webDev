...
// term
if ( !function_exists( 'marketo_get_category_term_list' ) ) :

    function marketo_get_category_term_list() {
        /**
        ...
        $result		 = array();
        $result[ 0 ]	 = esc_html__( 'All Categories', 'marketo' );
...
function marketo_defaults($options){
    ...
    $default = array(
        ...
        'show_fixed_footer' => '',
        'copyright_text' => esc_html__( 'Copyrights By Xpeedstudio - 2018', 'marketo' ),
