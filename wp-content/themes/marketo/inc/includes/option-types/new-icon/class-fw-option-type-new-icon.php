...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( MARKETO_INC . '/includes/option-types/new-icon/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'marketo' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'marketo' ),
					'hand'				 => esc_html__( 'Hand Icons', 'marketo' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'marketo' ),
					'gender'			 => esc_html__( 'Gender Icons', 'marketo' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'marketo' ),
					'payment'			 => esc_html__( 'Payment Icons', 'marketo' ),
					'currency'			 => esc_html__( 'Currency Icons', 'marketo' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'marketo' ),
					'directional'		 => esc_html__( 'Directional Icons', 'marketo' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'marketo' ),
					'brand'				 => esc_html__( 'Brand Icons', 'marketo' ),
					'medical'			 => esc_html__( 'Medical Icons', 'marketo' ),
					'marketo-icons'	 => esc_html__( 'Marketo Icons', 'marketo' ),
				),
				'icons'				 => array(
					...
					//Marketo Icons
                    'icon icon-search-minus' => array('group' => 'marketo-icons'),
                    'icon icon-search' => array('group' => 'marketo-icons'),
                    'icon icon-down-arrow' => array('group' => 'marketo-icons'),
                    'icon icon-up-arrow' => array('group' => 'marketo-icons'),
                    'icon icon-right-arrow' => array('group' => 'marketo-icons'),
                    'icon icon-left-arrows' => array('group' => 'marketo-icons'),
                    'icon icon-heart' => array('group' => 'marketo-icons'),
                    'icon icon-medical2' => array('group' => 'marketo-icons'),
                    'icon icon-eye2' => array('group' => 'marketo-icons'),
                    'icon icon-full-screen' => array('group' => 'marketo-icons'),
                    'icon icon-shuffle-arrow' => array('group' => 'marketo-icons'),
                    'icon icon-online-shopping-cart' => array('group' => 'marketo-icons'),
                    'icon icon-shopping-cart2' => array('group' => 'marketo-icons'),
                    'icon icon-apple-1' => array('group' => 'marketo-icons'),
                    'icon icon-apple' => array('group' => 'marketo-icons'),
                    'icon icon-watch' => array('group' => 'marketo-icons'),
                    'icon icon-cogwheel' => array('group' => 'marketo-icons'),
                    'icon icon-light-bulb' => array('group' => 'marketo-icons'),
                    'icon icon-light-bulb-1' => array('group' => 'marketo-icons'),
                    'icon icon-u-turn' => array('group' => 'marketo-icons'),
                    'icon icon-medal' => array('group' => 'marketo-icons'),
                    'icon icon-team-1' => array('group' => 'marketo-icons'),
                    'icon icon-team2' => array('group' => 'marketo-icons'),
                    'icon icon-team' => array('group' => 'marketo-icons'),
                    'icon icon-tshirt' => array('group' => 'marketo-icons'),
                    'icon icon-cancel' => array('group' => 'marketo-icons'),
                    'icon icon-drink' => array('group' => 'marketo-icons'),
                    'icon icon-home2' => array('group' => 'marketo-icons'),
                    'icon icon-music' => array('group' => 'marketo-icons'),
                    'icon icon-rich' => array('group' => 'marketo-icons'),
                    'icon icon-brush' => array('group' => 'marketo-icons'),
                    'icon icon-opposite-way' => array('group' => 'marketo-icons'),
                    'icon icon-cloud-computing' => array('group' => 'marketo-icons'),
                    'icon icon-technology-1' => array('group' => 'marketo-icons'),
                    'icon icon-rotate' => array('group' => 'marketo-icons'),
                    'icon icon-medical' => array('group' => 'marketo-icons'),
                    'icon icon-flash-1' => array('group' => 'marketo-icons'),
                    'icon icon-flash' => array('group' => 'marketo-icons'),
                    'icon icon-hours-support' => array('group' => 'marketo-icons'),
                    'icon icon-bag' => array('group' => 'marketo-icons'),
                    'icon icon-photo-camera' => array('group' => 'marketo-icons'),
                    'icon icon-school' => array('group' => 'marketo-icons'),
                    'icon icon-settings' => array('group' => 'marketo-icons'),
                    'icon icon-smartphone2' => array('group' => 'marketo-icons'),
                    'icon icon-technology-12' => array('group' => 'marketo-icons'),
                    'icon icon-tool' => array('group' => 'marketo-icons'),
                    'icon icon-business2' => array('group' => 'marketo-icons'),
                    'icon icon-star' => array('group' => 'marketo-icons'),
                    'icon icon-star-1' => array('group' => 'marketo-icons'),
                    'icon icon-favorite' => array('group' => 'marketo-icons'),
                    'icon icon-valentines-heart' => array('group' => 'marketo-icons'),
                    'icon icon-van-1' => array('group' => 'marketo-icons'),
                    'icon icon-van' => array('group' => 'marketo-icons'),
                    'icon icon-vegetables' => array('group' => 'marketo-icons'),
                    'icon icon-women' => array('group' => 'marketo-icons'),
                    'icon icon-left-arrow' => array('group' => 'marketo-icons'),
                    'icon icon-vintage' => array('group' => 'marketo-icons'),
                    'icon icon-up-arrow2' => array('group' => 'marketo-icons'),
                    'icon icon-arrows' => array('group' => 'marketo-icons'),
                    'icon icon-download-arrow' => array('group' => 'marketo-icons'),
                    'icon icon-facebook' => array('group' => 'marketo-icons'),
                    'icon icon-twitter' => array('group' => 'marketo-icons'),
                    'icon icon-dribbble' => array('group' => 'marketo-icons'),
                    'icon icon-linkedin' => array('group' => 'marketo-icons'),
                    'icon icon-youtube' => array('group' => 'marketo-icons'),
                    'icon icon-twitter3' => array('group' => 'marketo-icons'),
                    'icon icon-pinterest' => array('group' => 'marketo-icons'),
                    'icon icon-vimeo' => array('group' => 'marketo-icons'),
                    'icon icon-soundcloud' => array('group' => 'marketo-icons'),
                    'icon icon-youtube-v' => array('group' => 'marketo-icons'),
                    'icon icon-behance' => array('group' => 'marketo-icons'),
                    'icon icon-google-plus' => array('group' => 'marketo-icons'),
                    'icon icon-instagram' => array('group' => 'marketo-icons'),
                    'icon icon-double-left-chevron' => array('group' => 'marketo-icons'),
                    'icon icon-double-angle-pointing-to-right' => array('group' => 'marketo-icons'),
                    'icon icon-down-arrow2' => array('group' => 'marketo-icons'),
                    'icon icon-arrow-point-to-down' => array('group' => 'marketo-icons'),
                    'icon icon-play-button' => array('group' => 'marketo-icons'),
                    'icon icon-minus' => array('group' => 'marketo-icons'),
                    'icon icon-plus' => array('group' => 'marketo-icons'),
                    'icon icon-tick' => array('group' => 'marketo-icons'),
                    'icon icon-edit' => array('group' => 'marketo-icons'),
                    'icon icon-reply' => array('group' => 'marketo-icons'),
                    'icon icon-cogwheel-outline' => array('group' => 'marketo-icons'),
                    'icon icon-symbol' => array('group' => 'marketo-icons'),
                    'icon icon-calendar' => array('group' => 'marketo-icons'),
                    'icon icon-shopping-cart' => array('group' => 'marketo-icons'),
                    'icon icon-shopping-basket' => array('group' => 'marketo-icons'),
                    'icon icon-users2' => array('group' => 'marketo-icons'),
                    'icon icon-man' => array('group' => 'marketo-icons'),
                    'icon icon-support' => array('group' => 'marketo-icons'),
                    'icon icon-favorites' => array('group' => 'marketo-icons'),
                    'icon icon-calendar3' => array('group' => 'marketo-icons'),
                    'icon icon-paper-plane' => array('group' => 'marketo-icons'),
                    'icon icon-placeholder' => array('group' => 'marketo-icons'),
                    'icon icon-phone-call' => array('group' => 'marketo-icons'),
                    'icon icon-newsletter' => array('group' => 'marketo-icons'),
                    'icon icon-contact' => array('group' => 'marketo-icons'),
                    'icon icon-email' => array('group' => 'marketo-icons'),
                    'icon icon-envelope' => array('group' => 'marketo-icons'),
                    'icon icon-internet' => array('group' => 'marketo-icons'),
                    'icon icon-quote2' => array('group' => 'marketo-icons'),
                    'icon icon-tools2' => array('group' => 'marketo-icons'),
                    'icon icon-pie-chart2' => array('group' => 'marketo-icons'),
                    'icon icon-diamond' => array('group' => 'marketo-icons'),
                    'icon icon-like' => array('group' => 'marketo-icons'),
                    'icon icon-deal' => array('group' => 'marketo-icons'),
                    'icon icon-left-arrow2' => array('group' => 'marketo-icons'),
                    'icon icon-quote22' => array('group' => 'marketo-icons'),
                    'icon icon-right-arrow2' => array('group' => 'marketo-icons'),
                    'icon icon-coins-2' => array('group' => 'marketo-icons'),
                    'icon icon-commerce-2' => array('group' => 'marketo-icons'),
                    'icon icon-monitor' => array('group' => 'marketo-icons'),
                    'icon icon-business' => array('group' => 'marketo-icons'),
                    'icon icon-graphic-2' => array('group' => 'marketo-icons'),
                    'icon icon-commerce-1' => array('group' => 'marketo-icons'),
                    'icon icon-hammer' => array('group' => 'marketo-icons'),
                    'icon icon-justice-1' => array('group' => 'marketo-icons'),
                    'icon icon-line' => array('group' => 'marketo-icons'),
                    'icon icon-money-3' => array('group' => 'marketo-icons'),
                    'icon icon-commerce' => array('group' => 'marketo-icons'),
                    'icon icon-agenda' => array('group' => 'marketo-icons'),
                    'icon icon-justice' => array('group' => 'marketo-icons'),
                    'icon icon-technology' => array('group' => 'marketo-icons'),
                    'icon icon-coins-1' => array('group' => 'marketo-icons'),
                    'icon icon-bank' => array('group' => 'marketo-icons'),
                    'icon icon-calculator' => array('group' => 'marketo-icons'),
                    'icon icon-chart22' => array('group' => 'marketo-icons'),
                    'icon icon-checked' => array('group' => 'marketo-icons'),
                    'icon icon-clock3' => array('group' => 'marketo-icons'),
                    'icon icon-comment' => array('group' => 'marketo-icons'),
                    'icon icon-comments' => array('group' => 'marketo-icons'),
                    'icon icon-consult' => array('group' => 'marketo-icons'),
                    'icon icon-consut2' => array('group' => 'marketo-icons'),
                    'icon icon-folder' => array('group' => 'marketo-icons'),
                    'icon icon-invest' => array('group' => 'marketo-icons'),
                    'icon icon-loan' => array('group' => 'marketo-icons'),
                    'icon icon-map-marker2' => array('group' => 'marketo-icons'),
                    'icon icon-mutual-fund' => array('group' => 'marketo-icons'),
                    'icon icon-phone3' => array('group' => 'marketo-icons'),
                    'icon icon-pie-chart22' => array('group' => 'marketo-icons'),
                    'icon icon-play' => array('group' => 'marketo-icons'),
                    'icon icon-savings' => array('group' => 'marketo-icons'),
                    'icon icon-search3' => array('group' => 'marketo-icons'),
                    'icon icon-tag' => array('group' => 'marketo-icons'),
                    'icon icon-tags' => array('group' => 'marketo-icons'),
                    'icon icon-vplay' => array('group' => 'marketo-icons'),
                    'icon icon-mobile2' => array('group' => 'marketo-icons'),
                    'icon icon-laptop2' => array('group' => 'marketo-icons'),
                    'icon icon-desktop2' => array('group' => 'marketo-icons'),
                    'icon icon-tablet2' => array('group' => 'marketo-icons'),
                    'icon icon-phone2' => array('group' => 'marketo-icons'),
                    'icon icon-document' => array('group' => 'marketo-icons'),
                    'icon icon-documents' => array('group' => 'marketo-icons'),
                    'icon icon-search2' => array('group' => 'marketo-icons'),
                    'icon icon-clipboard2' => array('group' => 'marketo-icons'),
                    'icon icon-newspaper' => array('group' => 'marketo-icons'),
                    'icon icon-notebook' => array('group' => 'marketo-icons'),
                    'icon icon-book-open' => array('group' => 'marketo-icons'),
                    'icon icon-browser' => array('group' => 'marketo-icons'),
                    'icon icon-calendar2' => array('group' => 'marketo-icons'),
                    'icon icon-presentation' => array('group' => 'marketo-icons'),
                    'icon icon-picture' => array('group' => 'marketo-icons'),
                    'icon icon-pictures' => array('group' => 'marketo-icons'),
                    'icon icon-video' => array('group' => 'marketo-icons'),
                    'icon icon-camera2' => array('group' => 'marketo-icons'),
                    'icon icon-printer' => array('group' => 'marketo-icons'),
                    'icon icon-toolbox' => array('group' => 'marketo-icons'),
                    'icon icon-briefcase2' => array('group' => 'marketo-icons'),
                    'icon icon-wallet' => array('group' => 'marketo-icons'),
                    'icon icon-gift2' => array('group' => 'marketo-icons'),
                    'icon icon-bargraph' => array('group' => 'marketo-icons'),
                    'icon icon-grid' => array('group' => 'marketo-icons'),
                    'icon icon-expand2' => array('group' => 'marketo-icons'),
                    'icon icon-focus' => array('group' => 'marketo-icons'),
                    'icon icon-edit2' => array('group' => 'marketo-icons'),
                    'icon icon-adjustments' => array('group' => 'marketo-icons'),
                    'icon icon-ribbon' => array('group' => 'marketo-icons'),
                    'icon icon-hourglass2' => array('group' => 'marketo-icons'),
                    'icon icon-lock2' => array('group' => 'marketo-icons'),
                    'icon icon-megaphone' => array('group' => 'marketo-icons'),
                    'icon icon-shield2' => array('group' => 'marketo-icons'),
                    'icon icon-trophy2' => array('group' => 'marketo-icons'),
                    'icon icon-flag2' => array('group' => 'marketo-icons'),
                    'icon icon-map2' => array('group' => 'marketo-icons'),
                    'icon icon-puzzle' => array('group' => 'marketo-icons'),
                    'icon icon-basket' => array('group' => 'marketo-icons'),
                    'icon icon-envelope2' => array('group' => 'marketo-icons'),
                    'icon icon-streetsign' => array('group' => 'marketo-icons'),
                    'icon icon-telescope' => array('group' => 'marketo-icons'),
                    'icon icon-gears2' => array('group' => 'marketo-icons'),
                    'icon icon-key2' => array('group' => 'marketo-icons'),
                    'icon icon-paperclip2' => array('group' => 'marketo-icons'),
                    'icon icon-attachment' => array('group' => 'marketo-icons'),
                    'icon icon-pricetags' => array('group' => 'marketo-icons'),
                    'icon icon-lightbulb' => array('group' => 'marketo-icons'),
                    'icon icon-layers' => array('group' => 'marketo-icons'),
                    'icon icon-pencil2' => array('group' => 'marketo-icons'),
                    'icon icon-tools' => array('group' => 'marketo-icons'),
                    'icon icon-tools-2' => array('group' => 'marketo-icons'),
                    'icon icon-scissors2' => array('group' => 'marketo-icons'),
                    'icon icon-paintbrush' => array('group' => 'marketo-icons'),
                    'icon icon-magnifying-glass' => array('group' => 'marketo-icons'),
                    'icon icon-circle-compass' => array('group' => 'marketo-icons'),
                    'icon icon-linegraph' => array('group' => 'marketo-icons'),
                    'icon icon-mic' => array('group' => 'marketo-icons'),
                    'icon icon-strategy' => array('group' => 'marketo-icons'),
                    'icon icon-beaker' => array('group' => 'marketo-icons'),
                    'icon icon-caution' => array('group' => 'marketo-icons'),
                    'icon icon-recycle2' => array('group' => 'marketo-icons'),
                    'icon icon-anchor2' => array('group' => 'marketo-icons'),
                    'icon icon-profile-male' => array('group' => 'marketo-icons'),
                    'icon icon-profile-female' => array('group' => 'marketo-icons'),
                    'icon icon-bike' => array('group' => 'marketo-icons'),
                    'icon icon-wine' => array('group' => 'marketo-icons'),
                    'icon icon-hotairballoon' => array('group' => 'marketo-icons'),
                    'icon icon-globe2' => array('group' => 'marketo-icons'),
                    'icon icon-genius' => array('group' => 'marketo-icons'),
                    'icon icon-map-pin2' => array('group' => 'marketo-icons'),
                    'icon icon-dial' => array('group' => 'marketo-icons'),
                    'icon icon-chat' => array('group' => 'marketo-icons'),
                    'icon icon-heart2' => array('group' => 'marketo-icons'),
                    'icon icon-cloud2' => array('group' => 'marketo-icons'),
                    'icon icon-upload2' => array('group' => 'marketo-icons'),
                    'icon icon-download2' => array('group' => 'marketo-icons'),
                    'icon icon-target' => array('group' => 'marketo-icons'),
                    'icon icon-hazardous' => array('group' => 'marketo-icons'),
                    'icon icon-piechart' => array('group' => 'marketo-icons'),
                    'icon icon-speedometer' => array('group' => 'marketo-icons'),
                    'icon icon-global' => array('group' => 'marketo-icons'),
                    'icon icon-compass2' => array('group' => 'marketo-icons'),
                    'icon icon-lifesaver' => array('group' => 'marketo-icons'),
                    'icon icon-clock' => array('group' => 'marketo-icons'),
                    'icon icon-aperture' => array('group' => 'marketo-icons'),
                    'icon icon-quote' => array('group' => 'marketo-icons'),
                    'icon icon-scope' => array('group' => 'marketo-icons'),
                    'icon icon-alarmclock' => array('group' => 'marketo-icons'),
                    'icon icon-refresh2' => array('group' => 'marketo-icons'),
                    'icon icon-happy' => array('group' => 'marketo-icons'),
                    'icon icon-sad' => array('group' => 'marketo-icons'),
                    'icon icon-facebook2' => array('group' => 'marketo-icons'),
                    'icon icon-twitter2' => array('group' => 'marketo-icons'),
                    'icon icon-googleplus' => array('group' => 'marketo-icons'),
                    'icon icon-rss2' => array('group' => 'marketo-icons'),
                    'icon icon-tumblr2' => array('group' => 'marketo-icons'),
                    'icon icon-linkedin2' => array('group' => 'marketo-icons'),
                    'icon icon-dribbble2' => array('group' => 'marketo-icons'),
                    'icon icon-home' => array('group' => 'marketo-icons'),
                    'icon icon-apartment' => array('group' => 'marketo-icons'),
                    'icon icon-pencil' => array('group' => 'marketo-icons'),
                    'icon icon-magic-wand' => array('group' => 'marketo-icons'),
                    'icon icon-drop' => array('group' => 'marketo-icons'),
                    'icon icon-lighter' => array('group' => 'marketo-icons'),
                    'icon icon-poop' => array('group' => 'marketo-icons'),
                    'icon icon-sun' => array('group' => 'marketo-icons'),
                    'icon icon-moon' => array('group' => 'marketo-icons'),
                    'icon icon-cloud' => array('group' => 'marketo-icons'),
                    'icon icon-cloud-upload' => array('group' => 'marketo-icons'),
                    'icon icon-cloud-download' => array('group' => 'marketo-icons'),
                    'icon icon-cloud-sync' => array('group' => 'marketo-icons'),
                    'icon icon-cloud-check' => array('group' => 'marketo-icons'),
                    'icon icon-database' => array('group' => 'marketo-icons'),
                    'icon icon-lock3' => array('group' => 'marketo-icons'),
                    'icon icon-cog2' => array('group' => 'marketo-icons'),
                    'icon icon-trash2' => array('group' => 'marketo-icons'),
                    'icon icon-dice' => array('group' => 'marketo-icons'),
                    'icon icon-heart3' => array('group' => 'marketo-icons'),
                    'icon icon-star2' => array('group' => 'marketo-icons'),
                    'icon icon-star-half2' => array('group' => 'marketo-icons'),
                    'icon icon-star-empty' => array('group' => 'marketo-icons'),
                    'icon icon-flag3' => array('group' => 'marketo-icons'),
                    'icon icon-envelope3' => array('group' => 'marketo-icons'),
                    'icon icon-paperclip' => array('group' => 'marketo-icons'),
                    'icon icon-inbox' => array('group' => 'marketo-icons'),
                    'icon icon-eye' => array('group' => 'marketo-icons'),
                    'icon icon-printer2' => array('group' => 'marketo-icons'),
                    'icon icon-file-empty' => array('group' => 'marketo-icons'),
                    'icon icon-file-add' => array('group' => 'marketo-icons'),
                    'icon icon-enter' => array('group' => 'marketo-icons'),
                    'icon icon-exit' => array('group' => 'marketo-icons'),
                    'icon icon-graduation-hat' => array('group' => 'marketo-icons'),
                    'icon icon-license' => array('group' => 'marketo-icons'),
                    'icon icon-music-note' => array('group' => 'marketo-icons'),
                    'icon icon-film-play' => array('group' => 'marketo-icons'),
                    'icon icon-camera-video' => array('group' => 'marketo-icons'),
                    'icon icon-camera' => array('group' => 'marketo-icons'),
                    'icon icon-picture2' => array('group' => 'marketo-icons'),
                    'icon icon-book' => array('group' => 'marketo-icons'),
                    'icon icon-bookmark' => array('group' => 'marketo-icons'),
                    'icon icon-user2' => array('group' => 'marketo-icons'),
                    'icon icon-users' => array('group' => 'marketo-icons'),
                    'icon icon-shirt' => array('group' => 'marketo-icons'),
                    'icon icon-store' => array('group' => 'marketo-icons'),
                    'icon icon-cart' => array('group' => 'marketo-icons'),
                    'icon icon-tag2' => array('group' => 'marketo-icons'),
                    'icon icon-phone-handset' => array('group' => 'marketo-icons'),
                    'icon icon-phone' => array('group' => 'marketo-icons'),
                    'icon icon-pushpin' => array('group' => 'marketo-icons'),
                    'icon icon-map-marker' => array('group' => 'marketo-icons'),
                    'icon icon-map' => array('group' => 'marketo-icons'),
                    'icon icon-location' => array('group' => 'marketo-icons'),
                    'icon icon-calendar-full' => array('group' => 'marketo-icons'),
                    'icon icon-keyboard' => array('group' => 'marketo-icons'),
                    'icon icon-spell-check' => array('group' => 'marketo-icons'),
                    'icon icon-screen' => array('group' => 'marketo-icons'),
                    'icon icon-smartphone' => array('group' => 'marketo-icons'),
                    'icon icon-tablet' => array('group' => 'marketo-icons'),
                    'icon icon-laptop' => array('group' => 'marketo-icons'),
                    'icon icon-laptop-phone' => array('group' => 'marketo-icons'),
                    'icon icon-power-switch' => array('group' => 'marketo-icons'),
                    'icon icon-bubble' => array('group' => 'marketo-icons'),
                    'icon icon-heart-pulse' => array('group' => 'marketo-icons'),
                    'icon icon-construction' => array('group' => 'marketo-icons'),
                    'icon icon-pie-chart' => array('group' => 'marketo-icons'),
                    'icon icon-chart-bars' => array('group' => 'marketo-icons'),
                    'icon icon-gift' => array('group' => 'marketo-icons'),
                    'icon icon-diamond2' => array('group' => 'marketo-icons'),
                    'icon icon-dinner' => array('group' => 'marketo-icons'),
                    'icon icon-coffee-cup' => array('group' => 'marketo-icons'),
                    'icon icon-leaf' => array('group' => 'marketo-icons'),
                    'icon icon-paw' => array('group' => 'marketo-icons'),
                    'icon icon-rocket' => array('group' => 'marketo-icons'),
                    'icon icon-briefcase' => array('group' => 'marketo-icons'),
                    'icon icon-bus2' => array('group' => 'marketo-icons'),
                    'icon icon-car2' => array('group' => 'marketo-icons'),
                    'icon icon-train' => array('group' => 'marketo-icons'),
                    'icon icon-bicycle2' => array('group' => 'marketo-icons'),
                    'icon icon-wheelchair' => array('group' => 'marketo-icons'),
                    'icon icon-select' => array('group' => 'marketo-icons'),
                    'icon icon-earth' => array('group' => 'marketo-icons'),
                    'icon icon-smile' => array('group' => 'marketo-icons'),
                    'icon icon-sad2' => array('group' => 'marketo-icons'),
                    'icon icon-neutral' => array('group' => 'marketo-icons'),
                    'icon icon-mustache' => array('group' => 'marketo-icons'),
                    'icon icon-alarm' => array('group' => 'marketo-icons'),
                    'icon icon-bullhorn' => array('group' => 'marketo-icons'),
                    'icon icon-volume-high' => array('group' => 'marketo-icons'),
                    'icon icon-volume-medium' => array('group' => 'marketo-icons'),
                    'icon icon-volume-low' => array('group' => 'marketo-icons'),
                    'icon icon-volume' => array('group' => 'marketo-icons'),
                    'icon icon-mic2' => array('group' => 'marketo-icons'),
                    'icon icon-hourglass' => array('group' => 'marketo-icons'),
                    'icon icon-undo' => array('group' => 'marketo-icons'),
                    'icon icon-redo' => array('group' => 'marketo-icons'),
                    'icon icon-sync' => array('group' => 'marketo-icons'),
                    'icon icon-history' => array('group' => 'marketo-icons'),
                    'icon icon-clock2' => array('group' => 'marketo-icons'),
                    'icon icon-download3' => array('group' => 'marketo-icons'),
                    'icon icon-upload' => array('group' => 'marketo-icons'),
                    'icon icon-enter-down' => array('group' => 'marketo-icons'),
                    'icon icon-exit-up' => array('group' => 'marketo-icons'),
                    'icon icon-bug' => array('group' => 'marketo-icons'),
                    'icon icon-code2' => array('group' => 'marketo-icons'),
                    'icon icon-link' => array('group' => 'marketo-icons'),
                    'icon icon-unlink' => array('group' => 'marketo-icons'),
                    'icon icon-thumbs-up' => array('group' => 'marketo-icons'),
                    'icon icon-thumbs-down' => array('group' => 'marketo-icons'),
                    'icon icon-magnifier' => array('group' => 'marketo-icons'),
                    'icon icon-cross' => array('group' => 'marketo-icons'),
                    'icon icon-menu' => array('group' => 'marketo-icons'),
                    'icon icon-list' => array('group' => 'marketo-icons'),
                    'icon icon-chevron-up' => array('group' => 'marketo-icons'),
                    'icon icon-chevron-down' => array('group' => 'marketo-icons'),
                    'icon icon-chevron-left' => array('group' => 'marketo-icons'),
                    'icon icon-chevron-right' => array('group' => 'marketo-icons'),
                    'icon icon-arrow-up' => array('group' => 'marketo-icons'),
                    'icon icon-arrow-down' => array('group' => 'marketo-icons'),
                    'icon icon-arrow-left' => array('group' => 'marketo-icons'),
                    'icon icon-arrow-right' => array('group' => 'marketo-icons'),
                    'icon icon-move' => array('group' => 'marketo-icons'),
                    'icon icon-warning' => array('group' => 'marketo-icons'),
                    'icon icon-question-circle' => array('group' => 'marketo-icons'),
                    'icon icon-menu-circle' => array('group' => 'marketo-icons'),
                    'icon icon-checkmark-circle' => array('group' => 'marketo-icons'),
                    'icon icon-cross-circle' => array('group' => 'marketo-icons'),
                    'icon icon-plus-circle' => array('group' => 'marketo-icons'),
                    'icon icon-circle-minus' => array('group' => 'marketo-icons'),
                    'icon icon-arrow-up-circle' => array('group' => 'marketo-icons'),
                    'icon icon-arrow-down-circle' => array('group' => 'marketo-icons'),
                    'icon icon-arrow-left-circle' => array('group' => 'marketo-icons'),
                    'icon icon-arrow-right-circle' => array('group' => 'marketo-icons'),
                    'icon icon-chevron-up-circle' => array('group' => 'marketo-icons'),
                    'icon icon-chevron-down-circle' => array('group' => 'marketo-icons'),
                    'icon icon-chevron-left-circle' => array('group' => 'marketo-icons'),
                    'icon icon-chevron-right-circle' => array('group' => 'marketo-icons'),
                    'icon icon-crop' => array('group' => 'marketo-icons'),
                    'icon icon-frame-expand' => array('group' => 'marketo-icons'),
                    'icon icon-frame-contract' => array('group' => 'marketo-icons'),
                    'icon icon-layers2' => array('group' => 'marketo-icons'),
                    'icon icon-funnel' => array('group' => 'marketo-icons'),
                    'icon icon-text-format' => array('group' => 'marketo-icons'),
                    'icon icon-text-size' => array('group' => 'marketo-icons'),
                    'icon icon-bold' => array('group' => 'marketo-icons'),
                    'icon icon-italic' => array('group' => 'marketo-icons'),
                    'icon icon-underline' => array('group' => 'marketo-icons'),
                    'icon icon-strikethrough' => array('group' => 'marketo-icons'),
                    'icon icon-highlight' => array('group' => 'marketo-icons'),
                    'icon icon-text-align-left' => array('group' => 'marketo-icons'),
                    'icon icon-text-align-center' => array('group' => 'marketo-icons'),
                    'icon icon-text-align-right' => array('group' => 'marketo-icons'),
                    'icon icon-text-align-justify' => array('group' => 'marketo-icons'),
                    'icon icon-line-spacing' => array('group' => 'marketo-icons'),
                    'icon icon-indent-increase' => array('group' => 'marketo-icons'),
                    'icon icon-indent-decrease' => array('group' => 'marketo-icons'),
                    'icon icon-page-break' => array('group' => 'marketo-icons'),
                    'icon icon-hand' => array('group' => 'marketo-icons'),
                    'icon icon-pointer-up' => array('group' => 'marketo-icons'),
                    'icon icon-pointer-right' => array('group' => 'marketo-icons'),
                    'icon icon-pointer-down' => array('group' => 'marketo-icons'),
                    'icon icon-pointer-left' => array('group' => 'marketo-icons'),
				),
			),
		);
	}
