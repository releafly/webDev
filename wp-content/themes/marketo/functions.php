    ...
    function marketo_setup()
    {
        ...
        register_nav_menus(
            array(
                ...
                'secondary' => esc_html__('Secondary Menu', 'marketo'),
	    ...
	    global $marketo_dokan;
	    $marketo_dokan = new marketo_dokan();
    }
...
add_action( 'switch_theme', 'marketo_switch_theme_update_mods' );
function marketo_switch_theme_update_mods() {
